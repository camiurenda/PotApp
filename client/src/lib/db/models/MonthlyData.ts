...
export interface IMonthlyData extends Document {
  ...
  fixedPersonalExpenses: number // Gastos Fijos Personales
  netAvailable: number // Neto Disponible (calculado)
  createdAt: Date
  updatedAt: Date
}
...
// Índice compuesto para evitar duplicados por usuario/mes/año
MonthlyDataSchema.index({ userId: 1, year: 1, month: 1 }, { unique: true })

// Middleware para calcular netAvailable antes de guardar
